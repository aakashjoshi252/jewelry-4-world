...
import { CREATE_ORDER, UPDATE_CART_ITEM, REMOVE_FROM_CART } from '../../graphql/mutations';
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className={`w-full bg-gray-800 border border-transparent rounded-md py-3 px-4 flex items-center justify-center text-base font-light text-white hover:bg-gray-700 transition-colors ${isCheckingOut ? 'opacity-75 cursor-not-allowed' : ''}`}
