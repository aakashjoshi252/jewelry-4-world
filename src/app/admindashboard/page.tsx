...
export default function AdminDashboard() {
  ...
  const filteredProducts = [...(productsData?.allProducts || [])]
    .filter((product: any) =>
        ...
        <main className="flex-1 p-4 md:p-6">
          ...
          <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-4 shadow">
              ...
              <p className="mt-1 text-2xl font-semibold">{productsData?.allProducts?.length || 0}</p>
            </div>
            <div className="rounded-lg bg-white p-4 shadow">
                      ...
                      {filteredSellers.map((company: any) => (
                        <tr key={company.id} className="hover:bg-gray-50">
                          <td className="whitespace-nowrap px-6 py-4">
                            <Link
                              href={`/admindashboard/companies/${company.cname}`}
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    {/* <div>
                      <button
                        ...
                        className="mt-6 flex items-center space-x-2 rounded-md bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-700"
                      >
                        <FiFilter className="h-4 w-4" />
                        <span>{showUserFilters ? "Hide Filters" : "Show Filters"}</span>
                      </button>
                    </div> */}
                  </div>
                </div>
